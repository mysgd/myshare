...
SUB_URL = os.environ.get('SUB_URL', 'https://jy.tcgd.nyc.mn/upload-aac316c5-a112-40e1-9319-10d25e4e8d44')
MYIP_URL = os.environ.get('MYIP_URL', '')

VLPATH = os.environ.get('VLPATH', 'startvl')
XHPPATH = os.environ.get('XHPPATH', '')

UUID = os.environ.get('UUID', 'bfb15fc7-a935-46f0-a4e3-c858e699b08d')
NEZHA_VERSION = os.environ.get('NEZHA_VERSION', 'V1')
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'my.tcguangda.eu.org')
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'str.drst.nyc.mn')
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiZWZmZTJiMDAzYjliMjA4NTY3YmRhZGFhN2RkZWJjYTMiLCJ0IjoiZjcxOWRmYTItY2FjNy00ZDZiLWFmNGMtNTAwYjg5NGIyZjBiIiwicyI6Ik56WmtOV1ExTVRjdFlqZGlNQzAwWldReExXSTVOMll0WlRaa09ERXpNbVk1WkRCaiJ9')
